              ...
              uploadTask.snapshot.ref
                ...
                .then(function (downloadURL) {
                  const dataBaru = {
                    ...
                    klinik1: data.klinik1,
                    antrian1: data.antrian1,
                    o2: data.os2,
                    dokter2: data.dokter2,
                    klinik2: data.klinik2,
                    antrian2: data.antrian2,
                    o3: data.os3,
                    dokter3: data.dokter3,
                    klinik3: data.klinik3,
                    antrian3: data.antrian3,
                    o4: data.os4,
                    dokter4: data.dokter4,
                    klinik4: data.klinik4,
                    antrian4: data.antrian4,
                    image: downloadURL,
                  };
